...
Country boundaries are based on [FAO Global Administrative Unit Layes (GAUL)](https://www.fao.org/hih-geospatial-platform/news/detail/now-available--the-global-administrative-unit-layers-(gaul)-dataset---2024-edition/en). Earth Engine Asset: `FAO/GAUL_SIMPLIFIED_500m/2015/level0`

#### R scripts
A single R-script `ReplicateAnalyses.R' can be used to replciate the anlyses in the manuscrip. This includes a script to reproduce all 4 figures, as well as the unity-line regression analysis. 
